...
public enum Status {
    ...
    REQUEST                 ((byte)0x01,"REQUEST"),                          //Request
    RESPONSE                ((byte)0x02,"RESPONSE"),                         //Response
    PUBLISH_SERVICE         ((byte)0x03,"PUBLISH_SERVICE"),                  //发布服务
    PUBLISH_CANCEL_SERVICE  ((byte)0x04," PUBLISH_CANCEL_SERVICE"),          //取消发布
    SUBSCRIBE_SERVICE       ((byte)0x05,"SUBSCRIBE_SERVICE"),                //订阅服务
    OFFLINE_NOTICE          ((byte)0x06,"OFFLINE_NOTICE"),                   //通知下线
    ACK                     ((byte)0x07,"ACK"),                              //Acknowledge
    HEARTBEAT               ((byte)0x08,"HEARTBEAT"),                        //Heartbeat


    NOTHING                 ((byte)0x00,"NOTHING")
